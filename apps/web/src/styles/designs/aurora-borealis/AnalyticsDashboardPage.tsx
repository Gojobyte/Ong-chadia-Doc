      ...
      <main className="flex-1 overflow-y-auto bg-aurora relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              {/* Period Filter */}
              <div className="flex items-center gap-2 glass-colored rounded-xl border border-gray-200/50 p-1.5">
                <Calendar className="w-4 h-4 text-gray-400 ml-2" />
                <select
                  value={period}
                  onChange={(e) => setPeriod(e.target.value as Period)}
                  className="text-sm border-0 bg-transparent focus:ring-0 pr-8 py-1.5 font-medium text-gray-700"
                >
          ...
          <motion.div
            ...
            ref={dashboardRef}
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 card-aurora p-6 rounded-2xl"
          >
