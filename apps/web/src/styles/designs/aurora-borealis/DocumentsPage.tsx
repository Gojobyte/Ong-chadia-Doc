  ...
  return (
    <DashboardLayout>
      <div className="flex h-screen overflow-hidden w-full">
        {/* Folder Tree Panel - Aurora styled */}
        <aside className="w-72 bg-gradient-to-b from-[#2d1b4e] via-[#1e1338] to-[#150d28] border-r border-white/[0.08] flex-shrink-0 overflow-hidden flex flex-col">
          {/* Folder header */}
          <div className="px-4 py-4 border-b border-white/[0.08]">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl bg-gradient-to-br from-fuchsia-500 to-purple-600 shadow-lg shadow-fuchsia-500/25">
                <FolderOpen className="w-4 h-4 text-white" />
              </div>
              <div>
                <h2 className="font-semibold text-white">Dossiers</h2>
                <p className="text-xs text-violet-300/50">Organisez vos fichiers</p>
              </div>
            </div>
          </div>
          ...
          {/* Tag Cloud */}
          <div className="border-t border-white/[0.08] bg-[#150d28]">
            <TagCloud
        ...
        {/* Main Content */}
        <main className="flex-1 flex flex-col min-w-0 bg-aurora h-full overflow-hidden relative">
          {/* Aurora orbs */}
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-xl bg-gradient-to-br from-pink-500 to-fuchsia-600 shadow-lg shadow-pink-500/25">
                ...
                {/* Breadcrumb */}
                <div className="glass-colored rounded-xl border border-gray-200/50 px-4 py-2.5">
                  <FolderBreadcrumb
              ...
              >
                {!selectedFolderId ? (
                  <div className="flex flex-col items-center justify-center py-20">
                    <div className="w-20 h-20 rounded-3xl bg-pink-500/10 flex items-center justify-center mb-4 shadow-lg shadow-pink-500/10">
                      <FolderOpen className="w-10 h-10 text-pink-500" />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-20">
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 rounded-2xl bg-pink-500/20 blur-xl animate-pulse" />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="text-lg font-semibold text-rose-500">Erreur de chargement</p>
