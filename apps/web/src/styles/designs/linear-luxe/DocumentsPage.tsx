  ...
  return (
    <DashboardLayout>
      <div className="flex h-screen overflow-hidden w-full">
        {/* Folder Tree Panel - Premium styled */}
        <aside className="w-72 bg-white border-r border-slate-200/80 flex-shrink-0 overflow-hidden flex flex-col shadow-sm">
          {/* Folder header */}
        ...
        {/* Main Content */}
        <main className="flex-1 flex flex-col min-w-0 bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 h-full overflow-hidden">
          <div className="flex-1 overflow-y-auto">
            <div className="max-w-7xl mx-auto px-6 py-6">
              ...
              >
                ...
                {/* Breadcrumb */}
                <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-slate-200/60 px-4 py-2.5 shadow-sm">
                  <FolderBreadcrumb
              ...
              >
                {!selectedFolderId ? (
                  <div className="flex flex-col items-center justify-center py-20">
                    <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-indigo-100 to-violet-100 flex items-center justify-center mb-4">
                  ...
                  <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="mt-4 text-slate-500">Chargement des documents...</p>
                  </div>
                ) : error ? (
                  <div className="flex flex-col items-center justify-center py-20">
